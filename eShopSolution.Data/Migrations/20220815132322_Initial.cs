        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 8, 15, 20, 23, 19, 397, DateTimeKind.Local).AddTicks(3747)),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "00cd6e60-72dd-45cb-938f-18cb5d549852", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "b90dc36e-95ae-402a-86a8-2bd037986447", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "ninhthuan211@gmail.com", true, "Thuan", "Ninh", false, null, "ninhthuan211@gmail.com", "admin", "AQAAAAEAACcQAAAAEDAdColh/asU4VwH0DmS60Yn2GY+YAtzKtkcyfEQBQ3x67c4EVs9vPsxdsleOP91rg==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 8, 15, 20, 23, 19, 446, DateTimeKind.Local).AddTicks(4770), 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 2, "vi", "Áo nữ", "ao-nu", "Sản phẩm thời trang nữ", "Sản phẩm áo thời trang nữ" },
                    { 2, 1, "en", "Men Shirt", "men-shirt", "The shirt products for men", "The shirt products for men" },
                    { 4, 2, "en", "Women Shirt", "women-shirt", "The shirt products for women", "The shirt products for men" }
                });
